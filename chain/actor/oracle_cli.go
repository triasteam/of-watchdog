...
// GetSelectorResp is a free data retrieval call binding the contract method 0x7fc101be.
//
// Solidity: function getSelectorResp(uint256 i) view returns(uint256)
func (_FunctionOracle *FunctionOracleCaller) GetSelectorResp(opts *bind.CallOpts, i *big.Int) (*big.Int, error) {
	var out []interface{}
	err := _FunctionOracle.contract.Call(opts, &out, "getSelectorResp", i)
...
//
// Solidity: function getSelectorResp(uint256 i) view returns(uint256)
func (_FunctionOracle *FunctionOracleSession) GetSelectorResp(i *big.Int) (*big.Int, error) {
	return _FunctionOracle.Contract.GetSelectorResp(&_FunctionOracle.CallOpts, i)
}

// GetSelectorResp is a free data retrieval call binding the contract method 0x7fc101be.
//
// Solidity: function getSelectorResp(uint256 i) view returns(uint256)
func (_FunctionOracle *FunctionOracleCallerSession) GetSelectorResp(i *big.Int) (*big.Int, error) {
	return _FunctionOracle.Contract.GetSelectorResp(&_FunctionOracle.CallOpts, i)
}
