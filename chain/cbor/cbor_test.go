...
func Test_ParseCBOR(t *testing.T) {
	...
	address, err := TryParseHex("0x8bd112d3f8f92e41c861939545ad387307af9703")
	require.NoError(t, err)
...
func TestDecodeOBCR(t *testing.T) {
	var hexData = ""
	...
	decodedBytes, err := ParseDietCBOR(rawData)
	if err != nil {
		t.Error(err.Error())
		return
	}
